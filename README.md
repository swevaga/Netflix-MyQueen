...
| Panduan | Isi |
|---------|-----|
| [docs/ADMIN-GUIDE.md](./docs/ADMIN-GUIDE.md) | Admin Panel (`admin.html`): kelola berita, foto (path/URL + rasio), video + thumbnail, musik via GitHub API — media diisi sebagai path/URL (tanpa upload dari panel) |
